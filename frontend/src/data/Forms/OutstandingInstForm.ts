...
const OutstandingInstForm: FormEntry[] = [
    ...
    },
    {
        ...
        type: "textarea",
        hasValidations: true,
        validationType: 'word-limit',
        maxWords: [number from title],
        hasOptions: false,
        requiredStatus: true,
        page: 1,
        fieldsPerLine: 1,
...
maxWords: [number from title],
    ...
    {
    title:"Q18. Based on the responses given above, rate your institution on a scale of 1 to 5, where 1 is very poor and 5 is outstanding",
        type: "radio",
        requiredStatus: true,
